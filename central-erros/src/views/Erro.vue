      ...
      <div class="container-floud">
          <div class="col-xs-12 ground-color text-center">
              <div class="container-error-404">
                  <div class="clip"><div class="shadow"><span class="digit thirdDigit">{{ thirdDigit }}</span></div></div>
                  <div class="clip"><div class="shadow"><span class="digit secondDigit">{{ secondDigit }}</span></div></div>
...
export default {
  ...
  created: function() {
    let self = this;
    self.loop3 = setInterval(function() {
        if (self.i > 20) { 
            clearInterval(self.loop3)
            self.thirdDigit = 4;
        } else {
            self.thirdDigit = Math.floor(Math.random() * 9)+1;
            self.i++
        }     
    }, 30);
    self.loop2 = setInterval(function() {
        if (self.i > 40) {
            clearInterval(self.loop2);
            self.secondDigit = 0;
        } else {
            self.secondDigit = Math.floor(Math.random() * 9)+1;
            self.i++;
        }
    }, 30);
    self.loop1 = setInterval(function() {
        if (self.i > 60) {
            clearInterval(self.loop1);
            self.firstDigit = 4;
        } else {
            self.firstDigit = Math.floor(Math.random() * 9)+1;
            self.i++;
        }
    }, 30);
  },
